...
class SpeakshCLITests(unittest.TestCase):
    ...
    def test_version_flag_matches_project_metadata(self):
        metadata = tomllib.loads((ROOT / "pyproject.toml").read_text(encoding="utf-8"))
        expected_version = metadata["project"]["version"]

        self.assertEqual(speaksh.__version__, expected_version)
        res = self.run_cli("--version")

        self.assertEqual(res.returncode, 0, res.stderr + res.stdout)
        self.assertIn(f"speaksh {expected_version}", res.stdout)
